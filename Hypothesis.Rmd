...
Age and cohort are consistently the most important variables across different models.
Regularized regression models (Ridge and Elastic Net) provide a balance between prediction accuracy and model interpretability.

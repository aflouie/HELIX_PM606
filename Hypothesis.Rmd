...
```{r transposed serum data, warning = FALSE, echo=TRUE}
...
```{r cv k-fold LASSO, warning = FALSE}
...
```{r cv k-fold ridge, warning = FALSE}
perform_cv <- function(data, response, k = 10) {
  # make k-folds
  folds <- createFolds(data[[response]], k = k, list = TRUE, returnTrain = TRUE)
...
```{r cv k-fold enet, warning = FALSE}
perform_cv <- function(data, response, k = 10) {
  # make k-folds
  folds <- createFolds(data[[response]], k = k, list = TRUE, returnTrain = TRUE)
